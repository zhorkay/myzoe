...
import io.myzoe.config.annotation.RestEndpointAdvice;
...
public class RestServletContextConfiguration extends WebMvcConfigurerAdapter
{
    ...
    public void addCorsMappings(CorsRegistry registry)
    {
        registry
                .addMapping("/**")
                .allowedOrigins("*") //TODO Veszelyes Kikapcsolni Security Test
                .allowedMethods("GET", "POST", "PUT", "DELETE") //TODO Veszelyes Kikapcsolni Security Test
