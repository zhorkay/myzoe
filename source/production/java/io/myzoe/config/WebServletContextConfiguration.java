...
public class WebServletContextConfiguration extends WebMvcConfigurerAdapter
{
    ...
    public void addCorsMappings(CorsRegistry registry)
    {
        registry
                .addMapping("/**")
                .allowedOrigins("*") // Veszelyes Kikapcsolni Security Test
                .allowedMethods("GET") // Veszelyes Kikapcsolni Security Test
                .allowedMethods("POST")// Veszelyes Kikapcsolni Security Test
        ;
    }
